...
public class GeradorRelatorio {
    ...
    public static final String CAMINHO_RELATORIO = System.getProperty("user.dir") +
            File.separator + "Relatorio" +
            File.separator + "Relatorio" + DataTempo.pegaDataNoFormatoDoRelatorio();
    ...
    public synchronized static ExtentReports pegaInstancia(){
        ...
        htmlReporter = new ExtentHtmlReporter(CAMINHO_RELATORIO + File.separator +
                        "MeuRelatorio_" + DataTempo.pegaDataNoFormatoDoRelatorio() + ".html");
